...
export function Customers() {
  const { customers, projects, addCustomer, updateCustomer, deleteCustomer } = useStore()
  ...
  const handleSave = () => {
    if (editingCustomer) {
      updateCustomer({ ...editingCustomer, name, color })
    } else {
      addCustomer({ name, color })
    }
  ...
  return (
    <div style={{ padding: '24px' }}>
      <div className="page-header">
        <h2 style={{ color: TEXT_PRIMARY }}>Customers</h2>
